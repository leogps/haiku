...
public class NetworkFileOpenDialog extends JDialog {
    ...
    private static final Logger LOGGER = LogManager.getLogger(NetworkFileOpenDialog.class);
    ...
    public NetworkFileOpenDialog(NetworkFileOpenEventListener listener) {
        ...
        pasteFromClipboardLabel.setIcon(new ImageIcon(Objects.requireNonNull(NetworkFileOpenDialog.class.getClassLoader().getResource("icons/paste.png"))));
    }
