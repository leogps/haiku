package org.gps.haiku.ui.splash;
...
public class SplashAnimator {
    ...
    public static void main (String[] args) throws InterruptedException {
        ...
        String[] messages = new String[]{"Checking VLC Engine...", "Loading Properties...", "Registering Event Listeners", "Loading assets...",
                "Parsing assets", "Loading UI..."};
