...
public class Haiku {
    ...
    public static void main(String[] args) {
        ...
        if(OSInfo.isOSMac()) {
            ...
            ImageIcon imageIcon = new ImageIcon(Objects.requireNonNull(Haiku.class.getClassLoader().getResource("images/haiku.png")));
            try {
        ...
        try {
            ...
            LOGGER.debug("Checking VLC Engine...");
                ...
                if(isVlcjInitSucceeded()) {
                    ...
                    try {
                        ...
                        haikuPlayer.addMediaPlayerListener(new MediaPlayerEventListener() {
                            @Override
                            public void playing(HaikuPlayer player, final PlaylistItem currentTrack) {
