...
import org.gps.haiku.utils.ui.LabelCell;
import org.gps.haiku.vlcj.player.impl.HaikuPlayerImpl;
import org.gps.haiku.vlcj.player.events.NowPlayingListTrackSelectedEventListener;
...
public class PlaylistFrame extends javax.swing.JFrame {
    ...
    private final ImageIcon currentlyPlayingIcon = new ImageIcon(HaikuPlayerImpl.class.getClassLoader().getResource("images/play_20x20.png")) {
        @Override
    ...
    private final ImageIcon currentlyPausedIcon = new ImageIcon(HaikuPlayerImpl.class.getClassLoader().getResource("images/pause_20x20.png")) {
        @Override
        public String toString() {
            return "Paused";
        }
            ...
            public void mousePressed(MouseEvent me) {
                if(SwingUtilities.isLeftMouseButton(me)) {
                    ...
                    if (me.getClickCount() == 2) {
                        PlaylistItem playlistItem = (PlaylistItem) tableModel.getValueAt(row, NOW_PLAYING_LIST_DATA_CELL_INDEX);
                        for (NowPlayingListTrackSelectedEventListener nowPlayingListTrackSelectedEventListener :
                            ...
                            nowPlayingListTrackSelectedEventListener.onNowPlayingListTrackSelectedEvent(playlistItem);
                        }
                    }
                }
            }
    ...
    public void add(PlaylistItem playlistItem) {
        tableModel.addRow(new Object[]{
                ...
                Constants.EMPTY,
                playlistItem,
                playlistItem.getArtist(),
                playlistItem.getAlbum()});
    }
        ...
        SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                for (int i = 0; i < tableModel.getDataVector().size(); i++) {
                    ...
                    PlaylistItem playlistItem = (PlaylistItem) objectVector.get(NOW_PLAYING_LIST_DATA_CELL_INDEX);
                    if (playlistItem.getTrackId() == trackId) {
