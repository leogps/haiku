...
public class BasicPlayerControlPanel extends JPanel {
    ...
    public void setPaused() {
        ...
        SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                LOGGER.debug("Changing icon to: play");
    ...
    public void setPlaying() {
        ...
        SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                LOGGER.debug("Changing icon to: pause");
    ...
    private void createUIComponents() {
        ...
        try {
            ...
            showVolumeLabel = PropertyManager.containsProperty(property) &&
                    Boolean.parseBoolean(PropertyManager.getProperty(property));
        } catch (Exception ex) {
            LOGGER.debug("Failed to read property: " + property);
        }
